...
function checking() {  /*제목이 공백이나 null값이면 경고창이 나온다*/
	if (document.getElementById("title").value == "" || document.getElementById("title").value == null) {
		...
		document.inst.action="./adm_gongji_write.jsp"; /*제목이 공백이나 null값이 아니면 board_write.jsp로 이동*/
...
<body>
	<%
		GongjiService serv = new GongjiService();
		String day = serv.today(); //Board 서비스의 객체 생성 후 today 메소드 호출, 오늘 날짜를 구한다.
	%>
	<br><br>
	<div align=center>
	<form method="post" name="inst">  <!-- inst 폼에 입력한 값들이 board_write.jsp로 넘어간다 -->
