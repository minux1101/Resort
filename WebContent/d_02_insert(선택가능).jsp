...
function checking() {
   if (document.getElementById("name").value == "" || document.getElementById("name").value == null
      ...
      window.swal("필수 내용을 입력해주세요.");  /*이름, 예약날짜, 예약방, 전화번호가 null값일 때 경고창이 나온다.*/
   } else {
      document.reservation.action="d_02_write.jsp";  /*내용을 입력했으면 d_02_write.jsp로 이동*/
...
<form method="post" name="reservation">
   <table align=center>
      <tr>
         ...
         <td><input style="height:20px" type="text" name ="name" id="name"></td>
      </tr>
      <tr>
         <td width=100px height=30px>예약 일자 *</td>
         <% if (title != null) { %>
         		 <td><input type='date' min="<%=currentDate%>" max="<%=currentDate.plusDays(30)%>" name ="resv_date" id="resv_date"  value="<%=date %>"></td>             
         <% } else {%>
      ...
      <tr>
         ...
         <td><input style="height:20px" type="text" name ="telnum" id="telnum"></td>
      </tr>
      <tr>
         <td width=100px height=30px>입금자명</td>
         <td><input style="height:20px" type="text" name ="in_name" id="in_name"></td>
      </tr>
      <tr>
      ...
      <tr> <!-- 전송을 누르면 checking 함수를 호출 수행한다. -->
         <td height=30px></td>
         <td><input style="margin-left:140px" type=button value="예약" Onclick="checking()"></td>
      </tr>   
   </table>
</form>
</body>
