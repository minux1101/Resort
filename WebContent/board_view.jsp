...
<boby>
	...
	<table cellspacing=1 width=900 border=0 style="background-color:#FcFcFc;"> <!-- 들고온 공지의 값들을 테이블에서 출력한다. -->
	...
	<tr style="background-color:#F2F4F4;"> 
		<td style="text-align:center" width=150>조회수</td>
	...
	%>
   <tr style="background-color:#F2F4F4;">
   		<td style="text-align:center" width=150>파일</td>
   		<td colspan=3></td>
   </tr>
   <tr> 
	...
	<tr> 
		<td style="background-color:#F2F4F4; text-align:center" width=150>내용</td>
		<td colspan=3 style=overflow:scroll; height=300px><img src="upload\<%=file.getFileName()%>" width=500 height=350><%=board.getContent()%></td>
	</tr>
	...
	<tr> 
		<td style="background-color:#F2F4F4; text-align:center" width=150>댓글수준</td>
		<td style=border:0px; width=300><%=board.getRelevel()%></td>
		<td style="background-color:#F2F4F4; border:0;">댓글내 순서</td>
		<td><input style="border:none; background-color:#FcFcFc; width:100px" type="text" value="<%=board.getRecnt()%>"></td>
	</tr>
	</table>
	<br>
	<%
    ...
    <table width=900>
		<tr>
			<td width=700></td>
			<td><input type=button value="목록" Onclick="window.location='./e_02.jsp'">
